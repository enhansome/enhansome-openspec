...
* [Getting Started Guide](https://github.com/Fission-AI/OpenSpec/blob/main/docs/getting-started.md) ⭐ 68,084 | 🐛 280 | 🌐 TypeScript | 📅 2026-09-11 - Official getting started documentation.
* [OpenSpec](https://github.com/Fission-AI/OpenSpec/) ⭐ 68,084 | 🐛 280 | 🌐 TypeScript | 📅 2026-09-11 - Official OpenSpec CLI. Spec-driven development (SDD) for AI coding assistants.
...
* [OpenSpecUI](https://github.com/jixoai/openspecui) ⭐ 113 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-12 - Web interface for OpenSpec workflows with live mode and static export support.
...
* [speclens](https://github.com/dansreis/speclens) ⭐ 26 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-11 - Desktop reader for tracing requirement evolution and commenting on specs.
* [openspec-webui](https://github.com/oioi555/openspec-webui) ⭐ 14 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-12 - Interactive browser UI for browsing and managing specifications.
...
* [spec-gen](https://github.com/clay-good/spec-gen) ⭐ 303 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-12 - Reverse-engineers OpenSpec specs from existing codebases via static analysis and LLMs.
...
* [Flokay](https://github.com/pacaplan/flokay) ⭐ 30 | 🐛 5 | 🌐 Shell | 📅 2026-09-12 - Claude Code and Cursor plugin with plan-then-implement workflow and subagent dispatch.
...
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 797 | 🐛 8 | 🌐 JavaScript | 📅 2026-09-02 - OpenSpec planning with Superpowers execution across 17 platforms. (Chinese)
...
* [openspec-schemas by JiangWay](https://github.com/JiangWay/openspec-schemas) ⭐ 222 | 🐛 5 | 📅 2026-06-10 - Community schemas including a superpowers-bridge integration.
* [superpowers-openspec-team-skills](https://github.com/SYZ-Coder/superpowers-openspec-team-skills) ⭐ 194 | 🐛 1 | 🌐 PowerShell | 📅 2026-06-12 - Self-learning team skill library. (Chinese)
* [openspec-plus](https://github.com/sudokar/openspec-plus) ⭐ 182 | 🐛 0 | 📅 2026-09-03 - Agentic skills improving discovery, requirements, design decisions, and execution.
...
* [e2e-runbooks](https://github.com/Lukk17/openspec-schemas) ⭐ 0 | 🐛 0 | 📅 2026-09-12 - Capability-level e2e runbooks with behaviour-only assertions and token accounting.

## Templates & Starters

* [intent-driven-template](https://github.com/intent-driven-dev/intent-driven-template) ⭐ 130 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Template with ADRs, C4 diagrams, Gherkin, and TDD.
...
* [nuxt-supabase-starter](https://github.com/YuDefine/nuxt-supabase-starter) ⭐ 45 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-12 - Nuxt and Supabase starter with OpenSpec-based AI workflow. (Chinese)
...
* [OpenSpec-practise](https://github.com/ForceInjection/OpenSpec-practise) ⭐ 614 | 🐛 1 | 📅 2026-09-10 - Practical guide to OpenSpec v1.3.0 with SDD examples. (Chinese/English)
* [OpenSpec + Beads](https://github.com/cameronsjo/spec-compare/blob/main/docs/cheatsheet-beads-openspec.md) ⭐ 140 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-11 - Cheatsheet for OpenSpec with Beads.
* [spec-compare](https://github.com/cameronsjo/spec-compare) ⭐ 140 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-11 - Comparison of six SDD tools with decision frameworks and scoring matrices.
...
* [Spec-Kit](https://github.com/github/spec-kit) ⭐ 136,021 | 🐛 311 | 🌐 Python | 📅 2026-09-12 - GitHub's official SDD toolkit with CLI, templates, scaffolding, and AI integrations.
...
* [BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) ⭐ 52,943 | 🐛 33 | 🌐 Python | 📅 2026-09-12 - Agile AI-driven development using formal specs as single source of truth.
* [Kiro](https://github.com/kirodotdev/Kiro) ⭐ 4,287 | 🐛 1,666 | 🌐 TypeScript | 📅 2026-08-27 - AWS agentic IDE converting natural language into structured specs.
* [Spec Kitty](https://github.com/Priivacy-ai/spec-kitty) ⭐ 1,623 | 🐛 792 | 🌐 Python | 📅 2026-09-12 - SDD CLI workflow with Kanban dashboard, Git worktree isolation, and auto-merge.
* [ProductSpec](https://github.com/gokulrajaram/ProductSpec) ⭐ 288 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-19 - Open standard for capturing software intent before implementation.
...
* [Awesome AI-Driven Development](https://github.com/eltociear/awesome-AI-driven-development) ⭐ 541 | 🐛 7 | 📅 2026-09-07 - Curated list of 500+ AI-powered development tools.
* [Awesome Spec-Driven Development](https://github.com/Engineering4AI/awesome-spec-driven-development) ⭐ 264 | 🐛 0 | 📅 2026-09-12 - A curated list of awesome resources for spec-driven developmeny.
