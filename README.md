...
* [Getting Started Guide](https://github.com/Fission-AI/OpenSpec/blob/main/docs/getting-started.md) ⭐ 64,783 | 🐛 174 | 🌐 TypeScript | 📅 2026-08-13 - Official getting started documentation.
* [OpenSpec](https://github.com/Fission-AI/OpenSpec/) ⭐ 64,783 | 🐛 174 | 🌐 TypeScript | 📅 2026-08-13 - Official OpenSpec CLI. Spec-driven development (SDD) for AI coding assistants.
...
* [OpenSpecUI](https://github.com/jixoai/openspecui) ⭐ 98 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-03 - Web interface for OpenSpec workflows with live mode and static export support.
* [Spek](https://github.com/spekhq/spek) ⭐ 44 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-13 - Read-only viewer with BDD highlighting and full-text search for web, VS Code, and IntelliJ.
...
* [spec-gen](https://github.com/clay-good/spec-gen) ⭐ 279 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-13 - Reverse-engineers OpenSpec specs from existing codebases via static analysis and LLMs.
* [ralphy-openspec](https://github.com/wenqingyu/ralphy-openspec) ⭐ 193 | 🐛 2 | 🌐 TypeScript | 📅 2026-01-27 - Combines OpenSpec with Ralph Loop for iterative AI-assisted coding.
...
* [opencode-plugin-openspec](https://github.com/Octane0411/opencode-plugin-openspec) ⭐ 154 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-24 - OpenCode plugin with Architect mode for spec-only writes.
...
* [claude-plugin-sdd](https://github.com/joestump/claude-plugin-sdd) ⭐ 31 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-08 - Claude Code plugin for SDD with ADRs, OpenSpec specs, and sprint planning.
...
* [intellij-openspec](https://github.com/johnnyblabs/intellij-openspec) ⭐ 7 | 🐛 0 | 🌐 Java | 📅 2026-08-08 - IntelliJ IDEA plugin for OpenSpec, available on the JetBrains Marketplace.
...
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 739 | 🐛 6 | 🌐 JavaScript | 📅 2026-08-10 - OpenSpec planning with Superpowers execution across 17 platforms. (Chinese)
...
* [openspec-plus](https://github.com/sudokar/openspec-plus) ⭐ 148 | 🐛 0 | 📅 2026-07-23 - Agentic skills improving discovery, requirements, design decisions, and execution.
* [openspec-schemas](https://github.com/intent-driven-dev/openspec-schemas) ⭐ 85 | 🐛 1 | 📅 2026-08-03 - Custom workflow schemas including minimalist and event-driven templates.
...
* [intent-driven-template](https://github.com/intent-driven-dev/intent-driven-template) ⭐ 107 | 🐛 1 | 🌐 Python | 📅 2026-08-13 - Template with ADRs, C4 diagrams, Gherkin, and TDD.
...
* [nuxt-supabase-starter](https://github.com/YuDefine/nuxt-supabase-starter) ⭐ 45 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-13 - Nuxt and Supabase starter with OpenSpec-based AI workflow. (Chinese)
...
* [OpenSpec + Beads](https://github.com/cameronsjo/spec-compare/blob/main/docs/cheatsheet-beads-openspec.md) ⭐ 112 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-12 - Cheatsheet for OpenSpec with Beads.
* [spec-compare](https://github.com/cameronsjo/spec-compare) ⭐ 112 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-12 - Comparison of six SDD tools with decision frameworks and scoring matrices.
...
* [Spec-Kit](https://github.com/github/spec-kit) ⭐ 127,267 | 🐛 320 | 🌐 Python | 📅 2026-08-13 - GitHub's official SDD toolkit with CLI, templates, scaffolding, and AI integrations.
...
* [BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) ⭐ 51,862 | 🐛 129 | 🌐 JavaScript | 📅 2026-08-13 - Agile AI-driven development using formal specs as single source of truth.
* [Kiro](https://github.com/kirodotdev/Kiro) ⭐ 4,180 | 🐛 2,628 | 🌐 TypeScript | 📅 2026-06-22 - AWS agentic IDE converting natural language into structured specs.
* [Spec Kitty](https://github.com/Priivacy-ai/spec-kitty) ⭐ 1,503 | 🐛 645 | 🌐 Python | 📅 2026-08-13 - SDD CLI workflow with Kanban dashboard, Git worktree isolation, and auto-merge.
* [ProductSpec](https://github.com/gokulrajaram/ProductSpec) ⭐ 261 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-19 - Open standard for capturing software intent before implementation.
...
* [Awesome AI-Driven Development](https://github.com/eltociear/awesome-AI-driven-development) ⭐ 465 | 🐛 10 | 📅 2026-08-10 - Curated list of 500+ AI-powered development tools.
