...
* [Getting Started Guide](https://github.com/Fission-AI/OpenSpec/blob/main/docs/getting-started.md) ⭐ 69,766 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-21 - Official getting started documentation.
* [OpenSpec](https://github.com/Fission-AI/OpenSpec/) ⭐ 69,766 | 🐛 262 | 🌐 TypeScript | 📅 2026-09-21 - Official OpenSpec CLI. Spec-driven development (SDD) for AI coding assistants.
...
* [Spek](https://github.com/spekhq/spek) ⭐ 61 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-17 - Read-only viewer with BDD highlighting and full-text search for web, VS Code, and IntelliJ.
...
* [dossier](https://github.com/fselich/dossier) ⭐ 14 | 🐛 4 | 🌐 Go | 📅 2026-07-23 - Keyboard-driven TUI for navigating proposals, designs, specs, and tasks.
* [specgetty](https://github.com/speclib/specgetty) ⭐ 1 | 🐛 4 | 🌐 Go | 📅 2026-09-21 - Terminal UI for finding OpenSpec projects on your machine and reporting their status.

## Tools

* [spec-gen](https://github.com/clay-good/spec-gen) ⭐ 307 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-21 - Reverse-engineers OpenSpec specs from existing codebases via static analysis and LLMs.
...
* [gitguardex](https://github.com/opencue/gitguardex) ⭐ 27 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-21 - Runs parallel coding agents in isolated worktrees with OpenSpec auto-wired.
...
* [openspec-playwright](https://github.com/wxhou/openspec-playwright) ⭐ 10 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-21 - Playwright E2E testing with a self-healing three-agent pipeline.
...
* [claude-plugin-sdd](https://github.com/joestump/claude-plugin-sdd) ⭐ 32 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-21 - Claude Code plugin for SDD with ADRs, OpenSpec specs, and sprint planning.
...
* [Flokay](https://github.com/pacaplan/flokay) ⭐ 30 | 🐛 4 | 🌐 Shell | 📅 2026-09-21 - Claude Code and Cursor plugin with plan-then-implement workflow and subagent dispatch.
...
* [openspec-ext](https://github.com/RandyZ/openspec-ext) ⭐ 8 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-21 - VS Code and Cursor extension with a visual dashboard for changes and specs.
...
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 810 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-21 - OpenSpec planning with Superpowers execution across 17 platforms. (Chinese)
...
* [openspec-schemas](https://github.com/intent-driven-dev/openspec-schemas) ⭐ 101 | 🐛 1 | 📅 2026-08-16 - Custom workflow schemas including minimalist and event-driven templates.
...
* [intent-driven-template](https://github.com/intent-driven-dev/intent-driven-template) ⭐ 135 | 🐛 3 | 🌐 Python | 📅 2026-09-07 - Template with ADRs, C4 diagrams, Gherkin, and TDD.
...
* [nuxt-supabase-starter](https://github.com/YuDefine/nuxt-supabase-starter) ⭐ 45 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-21 - Nuxt and Supabase starter with OpenSpec-based AI workflow. (Chinese)
...
* [OpenSpec-practise](https://github.com/ForceInjection/OpenSpec-practise) ⭐ 619 | 🐛 1 | 📅 2026-09-10 - Practical guide to OpenSpec v1.3.0 with SDD examples. (Chinese/English)
* [OpenSpec + Beads](https://github.com/cameronsjo/spec-compare/blob/main/docs/cheatsheet-beads-openspec.md) ⭐ 146 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-11 - Cheatsheet for OpenSpec with Beads.
* [spec-compare](https://github.com/cameronsjo/spec-compare) ⭐ 146 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-11 - Comparison of six SDD tools with decision frameworks and scoring matrices.
...
* [Spec-Kit](https://github.com/github/spec-kit) ⭐ 138,222 | 🐛 299 | 🌐 Python | 📅 2026-09-21 - GitHub's official SDD toolkit with CLI, templates, scaffolding, and AI integrations.
...
* [BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) ⭐ 53,316 | 🐛 60 | 🌐 Python | 📅 2026-09-21 - Agile AI-driven development using formal specs as single source of truth.
* [Kiro](https://github.com/kirodotdev/Kiro) ⭐ 4,325 | 🐛 1,479 | 🌐 TypeScript | 📅 2026-09-15 - AWS agentic IDE converting natural language into structured specs.
* [Spec Kitty](https://github.com/Priivacy-ai/spec-kitty) ⭐ 1,636 | 🐛 810 | 🌐 Python | 📅 2026-09-21 - SDD CLI workflow with Kanban dashboard, Git worktree isolation, and auto-merge.
* [ProductSpec](https://github.com/gokulrajaram/ProductSpec) ⭐ 296 | 🐛 4 | 🌐 TypeScript | 📅 2026-07-19 - Open standard for capturing software intent before implementation.
...
* [pi-sdd-kit](https://github.com/felipefontoura/pi-sdd-kit) ⭐ 29 | 🐛 0 | 📅 2026-07-04 - Spec-driven development as skills for the Pi coding agent, with approval gates.
...
* [Awesome AI-Driven Development](https://github.com/eltociear/awesome-AI-driven-development) ⭐ 544 | 🐛 11 | 📅 2026-09-07 - Curated list of 500+ AI-powered development tools.
* [Awesome Spec-Driven Development](https://github.com/Engineering4AI/awesome-spec-driven-development) ⭐ 271 | 🐛 0 | 📅 2026-09-21 - A curated list of awesome resources for spec-driven developmeny.
