...
* [Getting Started Guide](https://github.com/Fission-AI/OpenSpec/blob/main/docs/getting-started.md) ⭐ 66,945 | 🐛 213 | 🌐 TypeScript | 📅 2026-09-01 - Official getting started documentation.
* [OpenSpec](https://github.com/Fission-AI/OpenSpec/) ⭐ 66,945 | 🐛 213 | 🌐 TypeScript | 📅 2026-09-01 - Official OpenSpec CLI. Spec-driven development (SDD) for AI coding assistants.
...
* [OpenSpecUI](https://github.com/jixoai/openspecui) ⭐ 107 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-28 - Web interface for OpenSpec workflows with live mode and static export support.
* [Spek](https://github.com/spekhq/spek) ⭐ 48 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-27 - Read-only viewer with BDD highlighting and full-text search for web, VS Code, and IntelliJ.
...
* [speclens](https://github.com/dansreis/speclens) ⭐ 24 | 🐛 5 | 🌐 TypeScript | 📅 2026-08-24 - Desktop reader for tracing requirement evolution and commenting on specs.
...
* [openspec-webui](https://github.com/oioi555/openspec-webui) ⭐ 12 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-28 - Interactive browser UI for browsing and managing specifications.
...
* [spec-gen](https://github.com/clay-good/spec-gen) ⭐ 290 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-01 - Reverse-engineers OpenSpec specs from existing codebases via static analysis and LLMs.
...
* [gitguardex](https://github.com/opencue/gitguardex) ⭐ 25 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-01 - Runs parallel coding agents in isolated worktrees with OpenSpec auto-wired.
...
* [openspec-playwright](https://github.com/wxhou/openspec-playwright) ⭐ 10 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-01 - Playwright E2E testing with a self-healing three-agent pipeline.
...
* [opencode-plugin-openspec](https://github.com/Octane0411/opencode-plugin-openspec) ⭐ 158 | 🐛 5 | 🌐 TypeScript | 📅 2026-03-24 - OpenCode plugin with Architect mode for spec-only writes.
...
* [claude-plugin-sdd](https://github.com/joestump/claude-plugin-sdd) ⭐ 31 | 🐛 4 | 🌐 JavaScript | 📅 2026-08-19 - Claude Code plugin for SDD with ADRs, OpenSpec specs, and sprint planning.
...
* [intellij-openspec](https://github.com/johnnyblabs/intellij-openspec) ⭐ 7 | 🐛 0 | 🌐 Java | 📅 2026-08-28 - IntelliJ IDEA plugin for OpenSpec, available on the JetBrains Marketplace.
...
* [openspec-ext](https://github.com/RandyZ/openspec-ext) ⭐ 6 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-01 - VS Code and Cursor extension with a visual dashboard for changes and specs.
* [openspec-tdd](https://github.com/yuritoledo/openspec-tdd) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2026-06-30 - Plugin for Claude Code, OpenCode, and Pi generating failing tests from specs.
...
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 780 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-01 - OpenSpec planning with Superpowers execution across 17 platforms. (Chinese)
* [flow-kit](https://github.com/rihebty/flow-kit) ⭐ 393 | 🐛 1 | 📅 2026-05-13 - Workflow kit merging BMAD, Spec-Kit, OpenSpec, GSD, and Superpowers. (Chinese)
* [openspec-schemas by JiangWay](https://github.com/JiangWay/openspec-schemas) ⭐ 219 | 🐛 5 | 📅 2026-06-10 - Community schemas including a superpowers-bridge integration.
* [superpowers-openspec-team-skills](https://github.com/SYZ-Coder/superpowers-openspec-team-skills) ⭐ 190 | 🐛 0 | 🌐 PowerShell | 📅 2026-06-12 - Self-learning team skill library. (Chinese)
* [openspec-plus](https://github.com/sudokar/openspec-plus) ⭐ 160 | 🐛 0 | 📅 2026-09-01 - Agentic skills improving discovery, requirements, design decisions, and execution.
* [openspec-schemas](https://github.com/intent-driven-dev/openspec-schemas) ⭐ 92 | 🐛 1 | 📅 2026-08-16 - Custom workflow schemas including minimalist and event-driven templates.
...
* [openspec-spec-driven-superpowers](https://github.com/Veath/openspec-spec-driven-superpowers) ⭐ 27 | 🐛 0 | 🌐 JavaScript | 📅 2026-03-27 - Adds superpowers-style planning and readiness gates.
...
* [intent-driven-template](https://github.com/intent-driven-dev/intent-driven-template) ⭐ 121 | 🐛 3 | 🌐 Python | 📅 2026-08-24 - Template with ADRs, C4 diagrams, Gherkin, and TDD.
...
* [nuxt-supabase-starter](https://github.com/YuDefine/nuxt-supabase-starter) ⭐ 45 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-29 - Nuxt and Supabase starter with OpenSpec-based AI workflow. (Chinese)
* [opencode-onboard](https://github.com/CKGrafico/opencode-onboard) ⭐ 31 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-28 - Prepares codebases for AI by wiring OpenCode, OpenSpec, and codegraph.
...
* [OpenSpec-practise](https://github.com/ForceInjection/OpenSpec-practise) ⭐ 598 | 🐛 1 | 📅 2026-08-19 - Practical guide to OpenSpec v1.3.0 with SDD examples. (Chinese/English)
* [OpenSpec + Beads](https://github.com/cameronsjo/spec-compare/blob/main/docs/cheatsheet-beads-openspec.md) ⭐ 131 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-30 - Cheatsheet for OpenSpec with Beads.
* [spec-compare](https://github.com/cameronsjo/spec-compare) ⭐ 131 | 🐛 3 | 🌐 TypeScript | 📅 2026-08-30 - Comparison of six SDD tools with decision frameworks and scoring matrices.
...
* [Spec-Kit](https://github.com/github/spec-kit) ⭐ 132,882 | 🐛 311 | 🌐 Python | 📅 2026-09-01 - GitHub's official SDD toolkit with CLI, templates, scaffolding, and AI integrations.
...
* [BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) ⭐ 52,560 | 🐛 32 | 🌐 JavaScript | 📅 2026-09-01 - Agile AI-driven development using formal specs as single source of truth.
* [Kiro](https://github.com/kirodotdev/Kiro) ⭐ 4,245 | 🐛 1,590 | 🌐 TypeScript | 📅 2026-08-27 - AWS agentic IDE converting natural language into structured specs.
* [Spec Kitty](https://github.com/Priivacy-ai/spec-kitty) ⭐ 1,581 | 🐛 677 | 🌐 Python | 📅 2026-08-31 - SDD CLI workflow with Kanban dashboard, Git worktree isolation, and auto-merge.
* [ProductSpec](https://github.com/gokulrajaram/ProductSpec) ⭐ 279 | 🐛 3 | 🌐 TypeScript | 📅 2026-07-19 - Open standard for capturing software intent before implementation.
...
* [Awesome AI-Driven Development](https://github.com/eltociear/awesome-AI-driven-development) ⭐ 529 | 🐛 2 | 📅 2026-08-29 - Curated list of 500+ AI-powered development tools.
