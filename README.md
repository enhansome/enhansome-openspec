...
* [Getting Started Guide](https://github.com/Fission-AI/OpenSpec/blob/main/docs/getting-started.md) ⭐ 66,405 | 🐛 191 | 🌐 TypeScript | 📅 2026-08-26 - Official getting started documentation.
* [OpenSpec](https://github.com/Fission-AI/OpenSpec/) ⭐ 66,405 | 🐛 191 | 🌐 TypeScript | 📅 2026-08-26 - Official OpenSpec CLI. Spec-driven development (SDD) for AI coding assistants.
...
* [OpenSpecUI](https://github.com/jixoai/openspecui) ⭐ 105 | 🐛 2 | 🌐 TypeScript | 📅 2026-08-19 - Web interface for OpenSpec workflows with live mode and static export support.
...
* [gitguardex](https://github.com/opencue/gitguardex) ⭐ 25 | 🐛 8 | 🌐 JavaScript | 📅 2026-08-26 - Runs parallel coding agents in isolated worktrees with OpenSpec auto-wired.
...
* [spec-superflow](https://github.com/MageByte-Zero/spec-superflow) ⭐ 772 | 🐛 7 | 🌐 JavaScript | 📅 2026-08-26 - OpenSpec planning with Superpowers execution across 17 platforms. (Chinese)
...
* [SuperSpec](https://github.com/danielhanold/superspec) ⭐ 61 | 🐛 0 | 📅 2026-05-26 - Drop-in schema integrating Superpowers execution discipline for traceable workflows.
...
* [OpenSpec + Beads](https://github.com/cameronsjo/spec-compare/blob/main/docs/cheatsheet-beads-openspec.md) ⭐ 125 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-25 - Cheatsheet for OpenSpec with Beads.
* [spec-compare](https://github.com/cameronsjo/spec-compare) ⭐ 125 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-25 - Comparison of six SDD tools with decision frameworks and scoring matrices.
...
* [Spec-Kit](https://github.com/github/spec-kit) ⭐ 131,802 | 🐛 335 | 🌐 Python | 📅 2026-08-27 - GitHub's official SDD toolkit with CLI, templates, scaffolding, and AI integrations.
...
* [BMAD-METHOD](https://github.com/bmad-code-org/BMAD-METHOD) ⭐ 52,372 | 🐛 131 | 🌐 JavaScript | 📅 2026-08-27 - Agile AI-driven development using formal specs as single source of truth.
* [Kiro](https://github.com/kirodotdev/Kiro) ⭐ 4,227 | 🐛 1,577 | 🌐 TypeScript | 📅 2026-08-27 - AWS agentic IDE converting natural language into structured specs.
* [Spec Kitty](https://github.com/Priivacy-ai/spec-kitty) ⭐ 1,572 | 🐛 676 | 🌐 Python | 📅 2026-08-27 - SDD CLI workflow with Kanban dashboard, Git worktree isolation, and auto-merge.
